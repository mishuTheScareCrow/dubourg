...
<section id="patent">
	<div class="container">
				...
				<div class="patent-content">
					<h2 class="patent-content-header">Things we do with Patent</h2>
					<ul class="patent-content-list">
						<li>Drafting</li>
						<li>Refreshability analysis</li>
						<li>Presentation</li>
						<li>Patent family</li>
						<li>Tracing</li>
						<li>Payment of annuities</li>
						<li>Searches and background analysis</li>
<!-- 						<li>Title8</li>
						<li>Title9</li>
						<li>Title10</li>
						<li>Title11</li>
