...
<section id="brand">
	<div class="container">
				...
				<div class="brand-content">
					<h2 class="brand-content-header">Things we do with trademarks</h2>
					<ul class="brand-content-list">
						<li>Request of trademark</li>
						<li>Flat fee for all Latin America</li>
						<li>P.O.A. with very few formalities</li>
						<li>Complete service of watch and defense service including oppositions</li>
<!-- 						<li>Title5</li>
						<li>Title6</li>
						<li>Title7</li>
						<li>Title8</li>
