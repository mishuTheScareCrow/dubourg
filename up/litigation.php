...
<html>
	...
	<title>Litigation | Dubourg</title>
...
<section id="litigation">
	<div class="container">
				...
				<div class="litigation-content">
					<h2 class="litigation-content-header">Things we do with litigation</h2>
					<ul class="litigation-content-list">
						<li>Trademark and patent conflicts to institute a lawsuit</li>
						<li>Make a defense at court</li>
						<li>All done by specialized lawyers with experience in the field. </li>
<!-- 						<li>Title4</li>
						<li>Title5</li>
						<li>Title6</li>
						<li>Title7</li>
