...
<section id="renewal">
	<div class="container">
				...
				<div class="renewal-content">
					<h2 class="renewal-content-header">Things we do with renewal</h2>
					<ul class="renewal-content-list">
						<li>We submit renewals in less than 24 hours with cheap costs</li>
<!-- 						<li>Title2</li>
						<li>Title3</li>
						<li>Title4</li>
						<li>Title5</li>
