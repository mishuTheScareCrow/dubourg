...
<html>
	...
	<title>Estimate Cost | Dubourg</title>
...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$subject='Estimate Cot Form';
		$body="Message :"."\t".$message."\n\n"."Email :"."\t".$email;
		$headers="From: ".$email;

		if(mail($to, $subject, $body, $headers)){
			$result="<h4 class='alert alert-success'>Thank You! You will get your eatimate by next 24hrs.</h4>";
		}
		else{
...
<section id="estimate-cost">
	<div class="estimate-cost-banner">
	<div class="container">
		<div class="overlay"></div>
		<div class="row">
			<div class="col-md-6">
				<div class="estimate-cost-header">
					<h2>Estimate the cost</h2>
					<h4>Have an idea of your costing before filing.</h4>
				</div>
			</div>
		</div>
	</div>
	</div>
	<div class="estimate-cost-content">
		<div class="container">
		<div class="col-md-12">
			...
			<div class="estimate-cost-txt">
				<p>Please send us your idea of name, country, and activity. We shall send you the result in the next 24 hours for free of charge.</p>
			</div>
		</div>
			<div class="col-md-6 centered">
				<form method="post" class="estimate-cost-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
					<div class="row">
						<div class="col-md-12">
							<textarea name="message" required="required" placeholder="Type of work* ( More information is better )"></textarea>
						</div>
						<div class="col-md-12">
							<input type="email" name="email" required="required" placeholder="Email*">
						</div>
						<div class="col-md-7">
							<input type="submit" name="submit" value="Estimate Now" class="btn btn-send">
						</div>
					</div>
				</form>
			</div>
