...
<html>
	...
	<title>Legal Department | Dubourg</title>
...
<section id="legal">
	<div class="container">
				...
				<div class="legal-content">
					<h2 class="legal-content-header">Things we do with legal</h2>
					<ul class="legal-content-list">
						<li>Registration and defense of trademarks and patents at administrative and judicial level in the market.</li>
						<li>Search for availability of brands, logos and patents.</li>
						<li>Criminal and customs actions for piracy and other trademark infringements for falsification of products or unauthorized use of trademarks.</li>
						<li>Innumerable amount of Administrative Remedial Actions and Annulment of administrative acts before the Ministry of Industry Energy and Mining (legal counsel) and before the Administrative Contentious Court.</li>
						<li>Civil and Criminal Defense for improper use of trademarks and copyrights.</li>
						<li>Registration, Protection, licensing of images of companies, people and advertising.</li>
						<li>Cessation of use and piracy by the unauthorized use of images and marks of people and companies.</li>
<!-- 						<li>Title8</li>
						<li>Title9</li>
						<li>Title10</li>
						<li>Title11</li>
				...
				<div class="sidebar-default">
					<div class="sidebar-default-content">
						<h2 class="sidebar-default-header"><i class="fa fa-globe" aria-hidden="true"></i> Online Services</h2>
                		<div class="list-group">
                    		<a href="https://daanguli.com/dubourg/trademark_search.php" class="list-group-item">Trademark Search</a>
                    		<a href="https://daanguli.com/dubourg/estimate_cost.php" class="list-group-item">Estimate Cost</a>
                		</div>
					</div>


					<div class="sidebar-default-content">
						<h2 class="sidebar-default-header"><i class="fa fa-suitcase" aria-hidden="true"></i> Our Services</h2>
                		<div class="list-group">
                    		<a href="https://daanguli.com/dubourg/trademark.php" class="list-group-item">Trademark</a>
                    		<a href="https://daanguli.com/dubourg/patent.php" class="list-group-item">Patent</a>
                    		<a href="https://daanguli.com/dubourg/renewals.php" class="list-group-item">Trademark Renewals</a>
                    		<a href="https://daanguli.com/dubourg/copyright.php" class="list-group-item">Copyright</a>
                    		<a href="https://daanguli.com/dubourg/domain.php" class="list-group-item">Software & Domain Names</a>
                    		<a href="https://daanguli.com/dubourg/litigation.php" class="list-group-item">Litigation</a>
                		</div>
                	</div>
				</div>
